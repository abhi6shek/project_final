...
for {set i 0} {$i < $val(layer) } { incr i } {
	...
	set d [expr ($l/2)] ;# for arranging node in right side hierarchy
	set f 1 ;# for arranging node in left side hierarchy
...
$node_(13) color blue
$ns_ at 0.0 "$node_(13) color blue"
$ns_ at 0.0 "$node_(13) label \"NN\""
...
$ns_ at 15.0 "$node_(13) setdest $c $d 6.0"
